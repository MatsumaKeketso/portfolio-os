...
const shortcuts: Shortcut[] = [
  ...
  { keys: ['Ctrl', 'O'], description: 'Open Archive', category: 'Navigation' },
  { keys: ['Ctrl', 'S'], description: 'Save (in apps)', category: 'Navigation' },
  { keys: ['Ctrl', 'N'], description: 'New File (in apps)', category: 'Navigation' },
  { keys: ['Ctrl', 'N'], description: 'New File', category: 'Archive' },
  { keys: ['Ctrl', 'Shift', 'N'], description: 'New Folder', category: 'Archive' },
  { keys: ['Delete'], description: 'Delete Selected File', category: 'Archive' },
  { keys: ['F2'], description: 'Rename File', category: 'Archive' },
