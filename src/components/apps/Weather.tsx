...
export function Weather() {
  ...
  const getWeatherIcon = (icon: string) => {
    switch (icon) {
      ...
      case 'cloud-rain': return <Icons.CloudRain className="w-8 h-8 text-blue-400" />;
      default: return <Icons.CloudSun className="w-8 h-8 text-yellow-400" />;
    }
  };

  return (
    <div className="w-full h-full bg-gradient-to-br from-blue-400 to-blue-600 p-6 overflow-y-auto">
