        ...
        >
          ...
          {currentStep === 0 && (
            <div className="relative p-8 pt-10">
              ...
              <div className="h-px bg-os-line-dark mb-7" />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
                {features.map((feature, index) => {
                  const Icon = feature.icon;
                  return (
                    <div key={index} className="bg-os-ink-900/55 border border-os-line-dark rounded-lg p-4 hover:bg-os-ink-800 transition-colors">
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-os-ink-800 rounded flex items-center justify-center flex-shrink-0 border border-os-line-dark">
          ...
          {currentStep === 1 && (
            <div className="relative p-8 pt-10">
              ...
              <div className="h-px bg-os-line-dark mb-6" />

              <div className="space-y-2 mb-8">
                {shortcuts.map((shortcut, index) => (
                  <div key={index} className="flex items-center justify-between bg-os-ink-900/55 border border-os-line-dark rounded px-4 py-3">
                    <span className="text-white/70 text-sm">{shortcut.action}</span>
                    <kbd className="px-2.5 py-1 bg-os-ink-800 border border-os-line-dark rounded text-white/80 text-xs font-mono">
                      {shortcut.keys}
                    </kbd>
                  </div>
                ))}
              ...
              <div className="bg-os-ink-900/55 border border-os-line-dark rounded p-4">
                <div className="flex items-start gap-3">
                  <Icons.Lightbulb className="w-4 h-4 text-white/40 mt-0.5 flex-shrink-0" />
                  <p className="text-white/50 text-sm">
                    Press <kbd className="px-1.5 py-0.5 bg-os-ink-800 border border-os-line-dark rounded text-xs font-mono text-white/70">?</kbd> anytime to view all keyboard shortcuts
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative p-8 pt-10">
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  <div key={n} className="flex items-start gap-4 bg-os-ink-900/55 border border-os-line-dark rounded-lg p-4">
                    <div className="w-7 h-7 bg-os-ink-800 border border-os-line-dark rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-os-ink-900/55 border border-os-line-dark rounded p-4 text-center">
